  ...
  <div class="survey">
      ...
      <p v-show="showError" class="error"> There are errors in the form data you have submitted. Sorry, please doublecheck your information. All fields are required.</p> 
        ...
        <p>Q2: What languages interest you the most?<br>
          <label v-for="(index,language) in languageOptions" v-bind:key="index">            <input type="checkbox" v-model="q2" v-bind:value="language.value">
          {{ language.text }}
          </label>
        </p>

        <p>Q3: What other topics interest you?<br>
          <label v-for="(index,topic) in topicOptions" v-bind:key="index">
